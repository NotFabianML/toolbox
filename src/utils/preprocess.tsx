...
export const thresholdFilter = (pixels: Uint8ClampedArray, level: number = 0.5) => {
...
export const getARGB = (data: Uint8ClampedArray, i: number) => {
    const offset = i * 4;
    return (
...
export const setPixels = (pixels: Uint8ClampedArray, data: Int32Array) => {
    let offset = 0;
...
export const blurARGB = (pixels: Uint8ClampedArray, canvas: HTMLCanvasElement, radius: number) => {
...
export const dilate = (pixels: Uint8ClampedArray, canvas: HTMLCanvasElement) => {
    let currIdx = 0;
